        ...
        >
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-primary-700 text-sm md:text-base">
              Understand what your signature style means exactly. <strong>Enter your email to receive your full description of your signature style</strong> with specific advice detailed recommendations, and unique tips to help you lean into your individual style.
            </p>
          </div>
